...
public class Database implements Serializable {
    ...
    public void createDb() {
        items.add(new GloceryItem(1,"Signal",125,100,"3/11","10/11","Uniliver",0.12));
        items.add(new GloceryItem(2,"Lifebouy",85,50,"1/15","10/15","Uniliver",0.25));
        items.add(new GloceryItem(3,"Sunlight",75,100,"3/11","10/11","Uniliver",0.13));
        items.add(new GloceryItem(4,"Raththi",450,500,"3/11","10/11","Cargills",0.02));
        ...
        items.add(new GloceryItem(12,"Knorr",125,100,"3/11","10/11","Uniliver",0.32));
